...
上面这些操作主要针对的还是block层级的，我们还需要划分线程实际拥有的数据，如下所示，先按照4x4的形状进行分块，然后按照2x2作为步长为每个线程分配数据
...
```cpp
gmem_ptr[32b](0x55a5e3137400) o (_4,_4):(_1,_8):
  0.00e+00  8.00e+00  1.60e+01  2.40e+01
  1.00e+00  9.00e+00  1.70e+01  2.50e+01
  2.00e+00  1.00e+01  1.80e+01  2.60e+01
  3.00e+00  1.10e+01  1.90e+01  2.70e+01

--- After local_partition (Thread 0's view) ---
Thread 0 shape: (_2,_2)
gmem_ptr[32b](0x55a5e3137400) o (_2,_2):(_2,_16):
  0.00e+00  1.60e+01
  2.00e+00  1.80e+01
```