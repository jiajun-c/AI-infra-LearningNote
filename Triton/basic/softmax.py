...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        line_vals=['triton', 'torch', 'TritionOneStage'],  # possible values for `line_arg``
        line_names=[
            "Triton",
            "Torch",
            "TritionOneStage",
...
def benchmark(M, N, provider):
    ...
    if provider == 'TritionOneStage':
        ms = triton.testing.do_bench(lambda: softmaxOneStage(x))
