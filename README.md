...
2. **LLM Training Infra**：先看 [Attention](./03-llm/arch/Attention/README.md)、[MoE](./03-llm/arch/MoE/README.md)，再进入 [TP](./03-llm/parallel/TP/README.md)、[PP](./10-dist/PP/README.md)、[FSDP](./10-dist/fsdp/README.md)。
...
- C++：[类型系统](./02-lang/cpp/type/README.md)、[内存管理](./02-lang/cpp/memory/README.md)、[内存模型与原子序](./02-lang/cpp/memory/memoryModel.md)、[模板](./02-lang/cpp/template/README.md)、[智能指针](./02-lang/cpp/point/README.md)、[STL vector](./02-lang/cpp/stl/vector/README.md)、[并发基础](./02-lang/cpp/thread/README.md)
...
- 并行训练：[DP](./10-dist/dp/README.md)、[DDP](./10-dist/DDP/README.md)、[FSDP](./10-dist/fsdp/README.md)、[HSDP](./10-dist/hsdp/README.md)、[H-FSDP](./10-dist/hfsdp/README.md)、[ZeRO](./10-dist/zero/README.md)、[Distributed Transpose](./10-dist/trans/README.md)、[TP](./03-llm/parallel/TP/README.md)、[PP](./10-dist/PP/README.md)、[EP](./03-llm/parallel/EP/README.md)
...
- GPU 架构文档重组：统一到 [01-cuda/hardware/](./01-cuda/hardware/README.md)，含 Hopper/Blackwell 专题和 SM 微架构；GPU 硬件名词速查见 [07-system/gpu/hardware/](./07-system/gpu/hardware/README.md)
- CUDA 算法专题：[01-cuda/algorithm/](./01-cuda/algorithm/)，含 radix sort、scan、prefix sum 等并行原语
...
- C++ 并发基础：[02-lang/cpp/thread/](./02-lang/cpp/thread/README.md)
...
- LLM 架构细节：[Dropout](./03-llm/arch/dropout/README.md)、[FFN](./03-llm/arch/ffn/README.md)
- FSDP/HSDP/[H-FSDP](./10-dist/hfsdp/README.md)/ZeRO（含 [ZeRO-1](./10-dist/zero/zero1.md) 字节账与前反向通信详解）、CP 序列并行（Megatron-SP / Ring Attention / Ulysses）
- NCCL Group Call、Zero-CTA、NCCL 与网络栈专题
- 网络拓扑：[04-comm/topo/](./04-comm/topo/README.md)（Fat-Tree 等）与 [NVLink-c2c](./04-comm/nvlinkc2c/README.md)
